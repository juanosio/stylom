                            ...
                            <div class="col-lg-12">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Registro de Categorias</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <center>
                                            <h4 class="box-title">Registro de Categorias</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card-body">
                                                {!! Form::model($categories, ['route' => ['categorias.update', $categories->id], 'id' => 'formulario_registro_categoria',  'method' => 'PUT']) !!}
                                                @method('PUT')
