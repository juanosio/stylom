                            ...
                            <div class="col-lg-12">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('materia-proveedores.create') }}">Pedido materia prima</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <center>
                                            <h4 class="box-title">Pedido de materia prima</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card-body">
                                                {!! Form::open(['route' => 'materia-proveedores.store', 'id' => 'formulario_registro_materia_proveedores']) !!}

                                                @include('materials_suppliers.partials.form')
